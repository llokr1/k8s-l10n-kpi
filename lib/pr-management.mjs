...
export const ASSIGNABLE_LOGINS = ["m3k0813", "bckmini", "neronsoda", "woonkim0413", "llokr1", "gpffh20", "ye11oc4t", "hkkim2021", "yucori", "wlgusqkr", "dongjune8931", "starbea", "suhyenim", "jiyubaek", "developowl"];
// Team identity remains separate from assignment eligibility (both teams).
export const REVIEWER_LOGINS = [...ASSIGNABLE_LOGINS, "callme-waffle", "superson7", "wafriend3416", "s0okju", "lylekim", "hong-p", "nahyun22", "ytjdud", "dianaland1112"];
